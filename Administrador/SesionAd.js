...
if (localStorage.getItem("admin") === "true") {
    window.location.href = "https://acceso-qr.vercel.app/Administrador/InicioAd.html"; // Redirige si ya está logueado
}
    ...
    get(adminRef).then((snapshot) => {
        if (snapshot.exists()) {
            ...
            if (adminData.contrasena && adminData.contrasena.toString() === contrasena) {
                ...
                window.location.href = "https://acceso-qr.vercel.app/Administrador/InicioAd.html";
            } else {
